...

  {
    ...
    if (ignored_error_code((expected_error = error_code)) ||
      ...
      */
      ...
      if (ddl_skip_rewrite != 0) {
        assert(ddl_skip_rewrite == 0 || ddl_skip_rewrite == 1);
        thd->variables.binlog_ddl_skip_rewrite = ddl_skip_rewrite;
      } else {
        thd->variables.binlog_ddl_skip_rewrite = false;
      }
